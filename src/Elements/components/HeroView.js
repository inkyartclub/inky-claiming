...
const navigation = [
  {
    name: "Inkpaper",
    href: "https://spaces.remotesoftwaredevelopment.com/the-inkpaper.pdf",
  },
...
export default function HeroView({
  ...
  return (
    <>
      <Toaster duration={30} position="top-center" reverseOrder={false} />
      <div className="relative overflow-hidden bg-black ">
              ...
              <div className="relative px-4 pt-6 sm:px-6 lg:px-8">
                ...
                >
                  ...
                  <div className="hidden md:block md:space-x-8 md:pr-4 tracking-tight">
                    <button
                      key="Inky Art Club Promo"
                      onClick={() => setShowPromo(true)}
                      className="font-bold text-gray-500 hover:text-white cursor-pointer"
                    >
                      Inky Art Club Promo
                    </button>
                    {navigation.map((item) => (
                  ...
                  <div className="overflow-hidden rounded-lg bg-black shadow-md ring-1 ring-black ring-opacity-5">
                    ...
                    <div className="space-y-1 px-2 pt-2 pb-3">
                      <a
                        key="Inky Art Club Promo"
                        onClick={() => setShowPromo(true)}
                        className="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-50 hover:text-gray-900 cursor-pointer"
                      >
                        Inky Art Club Promo
                      </a>
                      {navigation.map((item) => (
              ...
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl">
                  <span className="block md:inline">
                    Welcome to Inky's Art Club.
                  </span>{" "}
                  <span className="block text-green-400 lg:inline">
                    Claim your green NFTs today.
                  </span>
                </h1>
                <p className="mt-4 text-base text-gray-300 sm:mx-auto sm:mt-5 sm:max-w-xl text-xl md:mt-6 md:text-xl lg:mx-0">
                  Get access to an <b>entire decade</b> of adorable, unique, and
                  exclusive NFT art by holding a <b>Inky Super Pass</b>, every
                  single month. Start claiming below, join our community, and
                  support charities.
                </p>
                <div className="flex-row sm:flex sm:justify-center lg:justify-start mt-2">
                  ...
                  />
                  <div
                    className={`md:mt-12 md:mx-4 sm:mx-2 sm:mt-11 mt-6 ${
                      canClaimMode && ""
                    }`}
                  >
                      ...
                      {canClaimMode ? (
                        <button
                          ...
                          className={`flex w-full items-center justify-center rounded-md border border-transparent ${
                            allClaimed ? "bg-gray-500" : "bg-green-500"
                          ...
                          {allClaimed ? (
                            ...
                            <>
                              <div
                                className={`${
                                  canClaimMode &&
                                  "delay-300 animate-[spin_1s_ease-in-out]"
                                } onpress:animate-[spin_fade-in]`}
                              >
                                ⚡️
                              </div>
                              ️ Start Claiming
                        ...
                        <button
                          ...
                          className={`flex w-full items-center justify-center rounded-md border border-transparent ${
                            accountId.valid ? "bg-green-500" : "bg-gray-500"
                          } px-8 text-base font-medium text-white  ${
                            accountId.valid
                              ? "hover:bg-green-600"
                              : "hover:bg-gray-600"
                          } md:py-4 py-4 text-lg`}
                        >
                          {!!accountId.valid
                            ? "Check Claim Status"
                            : "Enter Account Id"}
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 2xl:right-36 pt-4">
          ...
          >
            <source
              src="https://spaces.remotesoftwaredevelopment.com/pass/INKY_PASS.m4v"
              type="video/mp4"
            />
          </video>
        </div>
